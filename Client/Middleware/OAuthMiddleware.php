...
namespace ClarifaiBundle\Client\Middleware;

use ClarifaiBundle\Client\AccessToken;
use ClarifaiBundle\Client\GrantType\GrantTypeBase;
use ClarifaiBundle\Client\GrantType\GrantTypeInterface;
use ClarifaiBundle\Client\GrantType\RefreshTokenGrantTypeInterface;
